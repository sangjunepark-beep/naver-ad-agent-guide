...
---
**사실**: 2026-04-24 KST 17:12 → 17:26 총 2회 PUT. 5군데 수정 완료.

- 17:12 PUT: jsCode 55,798자 → 62,304자 확장 (3곳 치환)
- 17:26 PUT: 5군데 추가 수정 (1곳 필드명 + 4곳 채널 뱃지)

### 필드명 버그 (17:26 수정)
- `storeAgg` 집계 시 `Number(p.구매전환수)` → `Number(p.전환수_구매)`
- 데이터_합산 노드 output 실제 필드명은 `전환수_구매`, `전환매출_구매`, `전환수_장바구니` 체계
- 17:12 PUT 당시 필드명 착오로 스토어별 전환 건수가 0으로 찍히던 이슈

### 채널 뱃지 교체 (17:26)
요약 탭 채널별 KPI 섹션의 chanRow 마지막 인자:
